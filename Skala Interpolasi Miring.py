...
image = cv.imread("riram.jpg")

fig, ax = plt.subplots(1, 3, figsize=(16, 8))

# Scaling image size to 0.15 times of its original size
...
# Scaling image size to 2 times of its original size
...
# Scaling image size to 200x400 pixels
